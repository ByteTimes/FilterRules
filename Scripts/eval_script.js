...
# JD
^https?://api\.m\.jd\.com/client\.action\?functionId=(wareBusiness|serverConfig) url script-response-body https://raw.githubusercontent.com/SavileLee/FilterRules/Rules/Scripts/JD_Price.js
# Taobao
tb_price.js = type=http-request,requires-body=1,pattern=^http://.+/amdc/mobileDispatch,script-path=https://raw.githubusercontent.com/SavileLee/FilterRules/Rules/Scripts/TB_Price.js
tb_price.js = type=http-response,requires-body=1,pattern=^https?://trade-acs\.m\.taobao\.com/gw/mtop\.taobao\.detail\.getdetail,script-path=https://raw.githubusercontent.com/SavileLee/FilterRules/Rules/Scripts/TB_Price.js
...
const __password = ""
// GitHub 用户名
const __owner = "SavileLee"
// GitHub 仓库名
const __repo = "FilterRules"
// GitHub 分支（不指定就使用默认分支）
const __branch = "Rules"
// 指定 eval_script.js 文件路径（路径为空 "" 使用脚本原始路径）
const __evalPath = "eval_script.js"
// GitHub 文件路径（没有文件新创建，已有文件覆盖更新，路径为空 "" 不更新）
const __quanxPath = "Scripts/eval_script/qx_script.txt"
const __surgePath = "Scripts/eval_script/sg_script.sgmodule"
// GitHub 更新日志
